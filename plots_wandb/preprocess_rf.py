...
if __name__ == '__main__':
    ...
    env = 'RF'
    experiment = 'learning_rate_0.00005'
    metrics = ['fraction_fully_dead_relu', 'fraction_weighted_dead_relu', 'average_reward']
    runs = ['demipeek/project_relu_demi/zv2oegvq',
            'demipeek/project_relu_demi/042xhkxk',]
